...
{
    SCVideoPlayerViewController*              _playerViewController;
}
@end
...
- (instancetype)initWithContentPath:(NSString *)path
    ...
    if (self) {
        _playerViewController = [SCVideoPlayerViewController viewControllerWithContentPath:path contentFrame:frame usingHWCodec:usingHWCodec playerStateDelegate:self parameters:parameters];
